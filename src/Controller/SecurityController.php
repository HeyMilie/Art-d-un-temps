...
class SecurityController extends AbstractController
{
    ...
    public function forgottenPassword(Request $request, UsersRepository $usersRepository, TokenGeneratorInterface $tokenGenerator, EntityManagerInterface $entityManager, SendMailService $mail): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            //On vérifié si on a un utilisateur
            if($user){
    ...
    public function resetPass(string $token, Request $request, UsersRepository $usersRepository, EntityManagerInterface $entityManager,UserPasswordEncoderInterface $passwordencoder): Response
    {
